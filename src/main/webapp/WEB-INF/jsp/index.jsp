    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 10rem;" src="img/covid19_2.png">
			<div >
				<h1 class="h3 mb-0 text-gray-800", style="font-size: 40px"><b> COVID 19 </b> - Tracking Dashboard</h1>
			</div>
		  <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 10rem;" src="img/sri-lanka-flag-small.jpg">
          </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">1530</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">754</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Suspected & Hospitalized</div>
